...
export interface ApiAuthorAuthor extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Blog authors with their profiles and social links';
    displayName: 'Author';
    pluralName: 'authors';
    singularName: 'author';
  };
...
export interface ApiContactSubmissionContactSubmission
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    userAgent: Schema.Attribute.Text & Schema.Attribute.Private;
  };
}
...
export interface ApiNewsletterSignupNewsletterSignup
  ...
  info: {
    description: 'Newsletter subscription management with comprehensive tracking and compliance features';
  ...
  attributes: {
    consent: Schema.Attribute.Component<'shared.consent-tracking', false> &
      Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    verificationExpires: Schema.Attribute.DateTime;
...
export interface ApiPagePage extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Static pages like About, Services, Contact';
    displayName: 'Page';
    pluralName: 'pages';
    singularName: 'page';
  };
...
export interface ApiPostPost extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Blog posts with MDX content support';
    displayName: 'Post';
    pluralName: 'posts';
    singularName: 'post';
  };
...
export interface ApiTagTag extends Struct.CollectionTypeSchema {
  collectionName: 'tags';
  info: {
    description: 'Blog post tags for better organization and search';
    displayName: 'Tag';
    pluralName: 'tags';
    singularName: 'tag';
  };
